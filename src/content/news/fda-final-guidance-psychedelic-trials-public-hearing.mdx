...
{/* TODO-ADAM: the Endpoints article is paywalled — the "eases abuse-study requirements" detail comes from its standfirst/preview only. Verify against the full article or the guidance document itself before publishing, or soften that sentence further. */}
